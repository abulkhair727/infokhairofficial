  ...
  return (
    <CardSection id="about" icon="👤" title="About Me">
      <p className="text-sm leading-[1.9] text-muted-foreground">
        ...
        successful career in tech.Whether it's crafting beautiful visuals, building responsive websites, or understanding
        how systems stay secure, I'm always eager to level up my skills and contribute positively to the digital world.
      </p>
