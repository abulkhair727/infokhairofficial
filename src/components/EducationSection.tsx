    ...
    <CardSection id="education" icon="🎓" title="Education">
      <div className="grid grid-cols-[repeat(auto-fit,minmax(155px,1fr))] gap-4">
        {education.map((e) => (
          <div
            key={e.title}
            className="cursor-default rounded-2xl border border-primary/8 bg-surface p-5 text-center transition-all hover:-translate-y-2 hover:scale-[1.03] hover:border-primary/40 hover:shadow-[0_0_25px_oklch(0.72_0.15_200/28%)]"
          >
